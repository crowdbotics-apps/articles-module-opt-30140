...
## Project Structure
    ...
    ├── articles_module_opt_30140  # Django project configurations
...
1. Clone this repo and `cd articles_module_opt_30140`
...
2. Clone this repo and `cd articles_module_opt_30140`
